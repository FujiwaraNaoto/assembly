...
; $ld -o counter_sample counter_sample.o

; $./counter_sample

;  ファイルオープンに失敗すると ERROR OPENと返す.
...
; sample.txt : you have to create this file. it's write only '0'.
...
FILE_DATA_READ: 
	...
	mov	rax,	[SYS_READ]	; system call READ  0x01
